...
class NotesDbProvider {
  Database db;
  static const String dbName = "notes23.db";
  ...
  Future _open({name = dbName}) async {
    if (db == null || db.isOpen) {
      ...
      db = await openDatabase(path, version: 1,
        ...
        await newDb.execute(
            "INSERT INTO notes(title,note,date_updated)VALUES('test','{\"0\":\"firstitem\",\"1\":\"secondItem\"}',datetime('now'))");
      });
    }
  }
  ...
  Future<List<NoteModel>> fetchNotes() async {
    ...
    final maps = await db.rawQuery("""
      SELECT n.id AS note_id, n.title, n.note, n.is_removed AS note_removed, n.is_favorite, n.date_created,n.date_updated,c.id AS category_id, c.name,c.color_identifier,c.is_removed AS category_removed,c.date_created
      FROM notes n
